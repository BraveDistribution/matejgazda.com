...
- **A Strong Linear Baseline for Whole-Heart Cardiac Shape Completion on CT, with an Open Eleven-Structure Statistical Shape Model.**
  ...
  *arXiv:2608.19932*, 2026.

- **Multitask Adversarial Network for 3D Cardiac Reconstruction and Segmentation from Biplane Echocardiography with Cross-Modality Shape Prior.**
